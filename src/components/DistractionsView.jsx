...
export default function DistractionsView({ tasks, onAdd, onToggle, onDelete, onClearDone, onReorder, onEdit }) {
  ...
  return (
    <div className="distractions-view">
      <div className="distractions-view-header">
        ...
        <span className="distractions-view-title">BRAIN DUMP</span>
      </div>
